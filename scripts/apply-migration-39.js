// Script para aplicar la migración 39 (Motivos de Discrepancia de Auditoría) a la base de datos de Supabase.
...
async function runWithUrl(url, label) {
    ...
    try {
        ...
        const migrationPath = path.resolve(__dirname, '../migration_39_inventory_audit_reasons.sql');
        const sql = fs.readFileSync(migrationPath, 'utf8');
        
        console.log("Aplicando migración 39...");
        await client.query(sql);
        console.log("¡Migración 39 aplicada con éxito en la base de datos!");
        await client.end();
        return true;
    } catch (err) {
